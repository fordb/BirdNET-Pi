<h1 align="center"><a href="https://github.com/fordb/BirdNET-Pi/blob/main/LICENSE">Review the license!!</a></h1>
...
```
curl -s https://raw.githubusercontent.com/fordb/BirdNET-Pi/main/newinstaller.sh | bash
```
